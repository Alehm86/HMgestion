...
public class PageProductsMainForm extends javax.swing.JPanel {
    
    ProductDAO queries = new ProductDAO();
    private String filaSeleccionada = "";
    //⚠️
    //✅
    public PageProductsMainForm() {
    ...
    private void start(){
        PageProductListForm p1 = new PageProductListForm();
        p1.setSize(1700, 800);
        p1.setLocation(0, 0);
    ...
    private void actionButtons(){
        ...
        btnAddStock.addActionListener(e -> {
            PageProductStockForm pStock = new PageProductStockForm();
...
//            this.dispose();
            PageProductInsertForm pNew = new PageProductInsertForm();
        ...
        btnEdit.addActionListener(e->{
            PageProductUpdateForm pEdit = new PageProductUpdateForm();
