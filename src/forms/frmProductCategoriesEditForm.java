...
public class frmProductCategoriesEditForm extends javax.swing.JDialog {
    ...
    public frmProductCategoriesEditForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();        
        inicializar();
        actionEdit();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmProductCategoriesEditForm dialog = new frmProductCategoriesEditForm(new javax.swing.JFrame(), true);
