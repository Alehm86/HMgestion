...
public class customerNewDialog extends javax.swing.JDialog {
    ...
    private void insertCLient(){                                //Alta cliente en tabla clients
...
//      VALIDA QUE EL DNI/CUIT NO SE REPITA          
        ...
        if(!txtHeight.getText().isEmpty()){
            mClient.height = Integer.parseInt(txtHeight.getText().trim());
        } else {
            mClient.height = 0;
        }  
        ...
        if (cboProvinces.getSelectedIndex() > 0) { 
            mClient.idProvince = queriesGeneric.selectId("id_province","provinces",cboProvinces.getSelectedItem().toString());
        } else {
        ...
        id_client = queriesCustomer.insertCustomer(
                mClient.getName(),
                mClient.getIva(),
                mClient.getCUIT(),
                mClient.getEmail(),
        ...
        queriesCustomer.insertCustomerHistory(id_client, fecha, "Alta cliente", "S/D");
        
        estado = true;
        
        cuitClient = mClient.getCUIT();
    ...
    private void initComponents() {
        ...
        lblErrorTipoClient.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        ...
        txtHeight.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)), "Altura", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Poppins", 0, 14))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jPanel2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 778, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(customerNewDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
