...
public class productSupplierEditDialog extends javax.swing.JDialog {
    ...
    public productSupplierEditDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tableSupplier.addMouseListener(new MouseAdapter(){
            public void mousePressed(MouseEvent Mouse_evt){
                ...
                if(Mouse_evt.getClickCount()==1){
                    ...
                    queriesProduct.selectSupplier(SupplierSelected, txtName, txtCondicion, txtCuit, txtTel, txtMail, txtUrl, txtUser, txtPass);
                    infoComboIva();
                }
                else{
                }            
        ...
        jPanelDatesLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelDatesLayout.createSequentialGroup()
                ...
                .addGroup(jPanelDatesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtCuit, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                productSupplierEditDialog dialog = new productSupplierEditDialog(new javax.swing.JFrame(), true);
