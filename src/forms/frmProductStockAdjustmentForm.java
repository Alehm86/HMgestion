...
public class frmProductStockAdjustmentForm extends javax.swing.JFrame {
    ...
    public frmProductStockAdjustmentForm() {
        initComponents();
    ...
    frmProductStockAdjustmentForm(frmProducts aThis, boolean b) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmProductStockAdjustmentForm().setVisible(true);
            }
        });
    }
