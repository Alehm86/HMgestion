...
public class frmProductBrandEditForm extends javax.swing.JDialog {
    ...
    public frmProductBrandEditForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmProductBrandEditForm dialog = new frmProductBrandEditForm(new javax.swing.JFrame(), true);
