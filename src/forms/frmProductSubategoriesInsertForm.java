...
public class frmProductSubategoriesInsertForm extends javax.swing.JDialog {
    ...
    public frmProductSubategoriesInsertForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents(); 
...
//        txtName.setEnabled(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmProductSubategoriesInsertForm dialog = new frmProductSubategoriesInsertForm(new javax.swing.JFrame(), true);
