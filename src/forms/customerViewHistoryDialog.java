...
public class customerViewHistoryDialog extends javax.swing.JDialog {
    ...
    public void dialogoId_client(int id_client){
        ...
        if (id_client < 0) {
            ...
            queriesCustomer.listCustomerHistory(table, idClient);
        }         
    } 
    
    public customerViewHistoryDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(customerViewHistoryDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                customerViewHistoryDialog dialog = new customerViewHistoryDialog(new javax.swing.JFrame(), true);
