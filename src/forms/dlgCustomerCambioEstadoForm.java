...
public class dlgCustomerCambioEstadoForm extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextArea1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(101, 129, 171)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgCustomerCambioEstadoForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgCustomerCambioEstadoForm dialog = new dlgCustomerCambioEstadoForm(new javax.swing.JFrame(), true);
