...
public class productSerialNumberHistoryDialog extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(productSerialNumberHistoryDialog.class.getName());

    productDAO qProduct = new productDAO();
    
    public productSerialNumberHistoryDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        actions();
    }
    ...
    private void buscar(String serialNumber){
    ...
    private void initComponents() {
        ...
        lbl_purchase_date.setForeground(new java.awt.Color(35, 35, 38));
        lbl_purchase_date.setText("-");

        lbl_sale_date.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lbl_sale_date.setForeground(new java.awt.Color(35, 35, 38));
        ...
        lbl_purchase_invoice.setForeground(new java.awt.Color(35, 35, 38));
        lbl_purchase_invoice.setText("-");

        lbl_warranty.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lbl_warranty.setForeground(new java.awt.Color(35, 35, 38));
        ...
        lbl_color.setForeground(new java.awt.Color(35, 35, 38));
        lbl_color.setText("-");

        lbl_purchase_price.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lbl_purchase_price.setForeground(new java.awt.Color(35, 35, 38));
        ...
        lbl_sale_price.setForeground(new java.awt.Color(35, 35, 38));
        ...
        lbl_status.setForeground(new java.awt.Color(35, 35, 38));
        lbl_status.setText("-");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                productSerialNumberHistoryDialog dialog = new productSerialNumberHistoryDialog(new javax.swing.JFrame(), true);
