...
public class PageCustomerHomeForm extends javax.swing.JPanel {
    
    ProductDAO queries = new ProductDAO();
    private String filaSeleccionada = "";
    //⚠️
    //✅
    public PageCustomerHomeForm() {
        initComponents();        
        actionButtons();
        start();
    }
    ...
    private void start(){
        PageCustomerListForm p1 = new PageCustomerListForm();
        p1.setSize(1700, 800);
        p1.setLocation(0, 0);
        
        jPanelClientContent.removeAll();
        jPanelClientContent.add(p1, BorderLayout.CENTER);
    ...
    private void actionButtons(){
        ...
        btnNewClient.addActionListener(e->{
            PageCustomerInsertForm pNewClient = new PageCustomerInsertForm();
        ...
        btnEditClient.addActionListener(e->{
            PageCustomerEditForm pEditClient = new PageCustomerEditForm();
            pEditClient.setSize(1700, 877);
            pEditClient.setLocation(0, 0);

            jPanelClientContent.removeAll();
            jPanelClientContent.add(pEditClient, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1712, 877));
            jPanelClientContent.revalidate();
            jPanelClientContent.repaint();
        });        
