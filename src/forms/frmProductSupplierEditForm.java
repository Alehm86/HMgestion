...
public class frmProductSupplierEditForm extends javax.swing.JDialog {
    ...
    public frmProductSupplierEditForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void editarProveedor() {
        ...
        classSupplier.name = txtName.getText().trim().toUpperCase();
        classSupplier.cuit = txtCuit.getText().trim();
        classSupplier.telefono = txtTel.getText().trim();
        classSupplier.email = txtMail.getText().trim();
        classSupplier.web = txtUrl.getText().trim();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmProductSupplierEditForm dialog = new frmProductSupplierEditForm(new javax.swing.JFrame(), true);
