...
public class frmProductCategoriesInsertForm extends javax.swing.JDialog {
    ...
    public frmProductCategoriesInsertForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();        
        actionButtons();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmProductCategoriesInsertForm dialog = new frmProductCategoriesInsertForm(new javax.swing.JFrame(), true);
