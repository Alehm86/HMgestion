...
public class HomeFrame extends javax.swing.JFrame {
    ...
    private void actionButtons(){
        ...
        btnClient.addActionListener(e -> {
            CustomerMainPanel pClient = new CustomerMainPanel();
...
//            dialogo.setVisible(true);
        ...
        jMenuNewSupplier.addActionListener(e -> {
            ProductSupplierNewDialog fNsupplier = new ProductSupplierNewDialog(this, true);
            fNsupplier.setVisible(true);
        });
        
        jMenuIEditSupplier.addActionListener(e -> {
            ProductSupplierEditDialog fEsupplier = new ProductSupplierEditDialog(this, true);
        ...
        jMenuIPrice.addActionListener(e -> {
            ProductPriceEditFrame fPrice = new ProductPriceEditFrame();
