...
public class dlgCustomerViewForm extends javax.swing.JDialog {
    ...
    public dlgCustomerViewForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//      VALIDA QUE EL DNI/CUIT NO SE REPITA          
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgCustomerViewForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgCustomerViewForm dialog = new dlgCustomerViewForm(new javax.swing.JFrame(), true);
