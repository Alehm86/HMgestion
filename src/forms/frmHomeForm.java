...
public class frmHomeForm extends javax.swing.JFrame {
    ...
    private void actionButtons(){
        ...
        btnProducts.addActionListener(e -> {
            PageProductsMainForm pProduct = new PageProductsMainForm();
        ...
        btnClient.addActionListener(e -> {
            PageCustomerMainForm pClient = new PageCustomerMainForm();
...
//            dialogo.setVisible(true);
        ...
        jMenuNewSupplier.addActionListener(e -> {
            frmProductSupplierInsertForm fNsupplier = new frmProductSupplierInsertForm(this, true);
            fNsupplier.setVisible(true);
        });
        
        jMenuIEditSupplier.addActionListener(e -> {
            frmProductSupplierEditForm fEsupplier = new frmProductSupplierEditForm(this, true);
        ...
        jMenuNewSubcat.addActionListener(e -> {
            frmProductSubategoriesInsertForm fNSubcat = new frmProductSubategoriesInsertForm(this, true);
            fNSubcat.setVisible(true);
        });
        
        jMenuEditSubcat.addActionListener(e -> {
            frmProductSubcategoriesEditForm fESubcat = new frmProductSubcategoriesEditForm(this, true);
            fESubcat.setVisible(true);
        });
        
        jMenuNewCat.addActionListener(e -> {
            frmProductCategoriesInsertForm fNcat = new frmProductCategoriesInsertForm(this, true);
            fNcat.setVisible(true);
        });
         
        jMenuEditCat.addActionListener(e -> {
            frmProductCategoriesEditForm fEcat = new frmProductCategoriesEditForm(this, true);
            fEcat.setVisible(true);
        });
        
        jMenuIPrice.addActionListener(e -> {
            frmProductPriceUpdate fPrice = new frmProductPriceUpdate();
...
//            fPrice.setVisible(true);
    ...
    private void initComponents() {
        ...
        jMenuNewCategory.add(jMenuIPrice);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmHomeForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
