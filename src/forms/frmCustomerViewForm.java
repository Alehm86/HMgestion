...
public class frmCustomerViewForm extends javax.swing.JFrame {
    ...
    public void dialogoEdit(String cuit){
        ...
        if(cuit != null && !cuitFound.isEmpty()){
            queriesCustomer.selectClientEdit(cuitFound, txtState, txtName, txtCUIT, txtTel, txtEmail, txtStreet, txtHeight, txtCity, txtIVA, txtProvince,txtState);
            infoCombo(); 
            colorEstado();
        }else{
    ...
    private void actions(){
        ...
        checkCambioEstado.addActionListener(e->{
            
            boolean activo = checkCambioEstado.isSelected();
        ...
        btnCambioEstado.addActionListener(e->{
            String cuit = cuitFound;
            String title = cboEstado.getSelectedItem().toString();
...
//      VALIDA QUE EL DNI/CUIT NO SE REPITA          
        ...
        if(!txtState.getText().isEmpty()){
            mClient.ID = Integer.parseInt(txtState.getText());
        } else {
            valido = false;
        }          
    ...
    private void initComponents() {
        ...
        checkCambioEstado = new javax.swing.JCheckBox();
        ...
        txtID1.setFont(new java.awt.Font("Poppins", 1, 18)); // NOI18N
        ...
        checkCambioEstado.setFont(new java.awt.Font("Poppins", 1, 14)); // NOI18N
        checkCambioEstado.setForeground(new java.awt.Color(12, 83, 151));
        checkCambioEstado.setText("Cambiar estado");

        cboEstado.setBackground(new java.awt.Color(255, 255, 255));
        cboEstado.setFont(new java.awt.Font("Poppins", 1, 14)); // NOI18N
        cboEstado.setForeground(new java.awt.Color(12, 83, 151));
        cboEstado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Dar de baja", "Suspender", "Reactivar" }));
        ...
        btnCambioEstado.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/eliminarCliente.png"))); // NOI18N
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(checkCambioEstado)
                .addGap(18, 18, 18)
        ...
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(checkCambioEstado, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCustomerViewForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmCustomerViewForm().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JCheckBox checkCambioEstado;
