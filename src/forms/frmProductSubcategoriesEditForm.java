...
public class frmProductSubcategoriesEditForm extends javax.swing.JDialog {
    ...
    public frmProductSubcategoriesEditForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmProductSubcategoriesEditForm dialog = new frmProductSubcategoriesEditForm(new javax.swing.JFrame(), true);
