...
public class DlgCustomerSearchForm extends javax.swing.JDialog {
    ...
    public DlgCustomerSearchForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        queriesGeneric.llenarCombos(cboIVA, "iva");
  
        queriesCustomer.listAllCustomer(tableCustomer);
    ...
    private void actions(){
        ...
        cboIVA.addActionListener(e->{
            ...
            if (cboIVA.getSelectedIndex() > 0) {
                queriesCustomer.listCustomerForIva(tableCustomer, idIva);
            } else {
                queriesCustomer.listAllCustomer(tableCustomer);
            }
        ...
        btnSelect.addActionListener(e->{
            cuitFound = queriesCustomer.selectCUIT(filaSeleccionada);            
            this.dispose();
        });
    ...
    private void initComponents() {
        ...
        btnSelect.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/User.png"))); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(cboIVA, 0, 258, Short.MAX_VALUE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgCustomerSearchForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgCustomerSearchForm dialog = new DlgCustomerSearchForm(new javax.swing.JFrame(), true);
