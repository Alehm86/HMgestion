...
public class frmProductSupplierInsertForm extends javax.swing.JDialog {
    ...
    public frmProductSupplierInsertForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmProductSupplierInsertForm dialog = new frmProductSupplierInsertForm(new javax.swing.JFrame(), true);
