...
public class cashRegisterDashboard extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnBook.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        btnBook.setForeground(new java.awt.Color(12, 83, 151));
        btnBook.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/libro32.png"))); // NOI18N
        btnBook.setText("Libro diario");

        btnSales.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        btnSales.setForeground(new java.awt.Color(12, 83, 151));
        btnSales.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/cashRegister32.png"))); // NOI18N
