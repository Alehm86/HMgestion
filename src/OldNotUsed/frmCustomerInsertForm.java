...
public class frmCustomerInsertForm extends javax.swing.JFrame {
...
//      VALIDA QUE EL DNI/CUIT NO SE REPITA          
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCustomerInsertForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmCustomerInsertForm().setVisible(true);
            }
        });
    }
